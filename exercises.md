...
*nb* If you start working with the R exercises below, I would suggest you read the introductory bits from Lincoln Mullen's book-in-practice, [DH Methods in R](http://dh-r.lincolnmullen.com/introduction.html), especially the 'setup' part under 'getting started' (pay attention to the bit on installing packages and dependencies). If you spot any exercises in Mullen's book that seem relevant to your project, you may do those as an alternative to the ones here. 
